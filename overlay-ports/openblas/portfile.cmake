...
# Overlay: x64-linux-custom-release 强制 TARGET=HASWELL，必须跳过 getarch（否则 getarch 会检测宿主机 skylake-avx512）
if(TARGET_TRIPLET STREQUAL "x64-linux-custom-release")
    list(APPEND OPTIONS "-DTARGET=HASWELL")
    message(STATUS "OpenBLAS overlay: TARGET=HASWELL for x64-linux-custom-release (no getarch, GCC 8, no AVX512)")
    set(GETARCH_BINARY_DIR "")
...
if(NOT TARGET_TRIPLET STREQUAL "x64-linux-custom-release")
    string(REPLACE "WindowsStore_" "_" SYSTEM_KEY "${VCPKG_CMAKE_SYSTEM_NAME}_${VCPKG_TARGET_ARCHITECTURE}")
